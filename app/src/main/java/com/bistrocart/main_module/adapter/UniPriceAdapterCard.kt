...
class UniPriceAdapterCard(
    private val itemList: List<MyCartRes.Data.Price>,
    public  var unitSelect: String,
    private val itemClickCallback: ItemClickCallback
) :
    RecyclerView.Adapter<UniPriceAdapterCard.ViewHolder>() {
    private var lastClickedPosition = -1

    interface ItemClickCallback {
        fun onItemClick(item: MyCartRes.Data.Price, type: Int)
    }
    ...
    inner class ViewHolder(private val binding: AdapterProductPriceBinding) :
        ...
        fun bind(item: MyCartRes.Data.Price, position: Int) {
